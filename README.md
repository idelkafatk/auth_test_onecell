...
> Отметил какие проверки удалось сделать. Некоторые проверки невозможно сделать в рамках тестового задания из-за недостатка информации или отсутсвия доступа к функциональности
